...
function newList(){setMenu(false);if(!confirm('Criar uma nova lista? Todos os registros atuais serão limpos.'))return;activeListId=null;applyState({athletes:[],mode:'services',logo:'assets/img/logo.png',event:'',date:'',raw:''})}
